<template>
  <v-content>
    <v-container>
      <v-layout row wrap>
        <v-flex xs12>
          <h1>Presenter: April Kwong {{ $route.params.slug }}</h1>
          <v-img
            width="200px"
          ...
          <v-btn small>Follow @araphoenix</v-btn>
          <p>
            Website: <a href="https://aralovelace.com" target="_blank">https://aralovelace.com</a>
          </p>
        </v-flex>
      </v-layout>
      <v-layout row wrap>
